...
import type { GetReports200ResponseAllOfDataInner } from './GetReports200ResponseAllOfDataInner';
import {
    GetReports200ResponseAllOfDataInnerFromJSON,
    GetReports200ResponseAllOfDataInnerFromJSONTyped,
    GetReports200ResponseAllOfDataInnerToJSON,
    GetReports200ResponseAllOfDataInnerToJSONTyped,
} from './GetReports200ResponseAllOfDataInner';
...
export interface GetReports200Response {
     ...
     * @type {Array<GetReports200ResponseAllOfDataInner>}
     * @memberof GetReports200Response
     */
    data?: Array<GetReports200ResponseAllOfDataInner>;
}
...
export function GetReports200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetReports200Response {
    ...
    return {
        ...
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(GetReports200ResponseAllOfDataInnerFromJSON)),
    };
}
...
export function GetReports200ResponseToJSONTyped(value?: Omit<GetReports200Response, 'pageNumber'|'pageSize'|'totalPages'|'totalCount'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(GetReports200ResponseAllOfDataInnerToJSON)),
    };
}
