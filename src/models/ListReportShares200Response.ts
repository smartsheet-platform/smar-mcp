 ...
 * 
 * @export
 * @interface ListReportShares200Response
 */
export interface ListReportShares200Response {
    /**
     ...
     * @type {number}
     * @memberof ListReportShares200Response
     */
...
/**
 * Check if a given object implements the ListReportShares200Response interface.
 */
export function instanceOfListReportShares200Response(value: object): value is ListReportShares200Response {
    return true;
}

export function ListReportShares200ResponseFromJSON(json: any): ListReportShares200Response {
    return ListReportShares200ResponseFromJSONTyped(json, false);
}

export function ListReportShares200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListReportShares200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ListReportShares200ResponseToJSON(json: any): ListReportShares200Response {
    return ListReportShares200ResponseToJSONTyped(json, false);
}

export function ListReportShares200ResponseToJSONTyped(value?: Omit<ListReportShares200Response, 'pageNumber'|'pageSize'|'totalPages'|'totalCount'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
