...
import {createSmartsheetDirectAPI, SmartsheetDirectAPI} from "./smartsheet-direct-api";
...
interface Env {
  ...
  SMARTSHEET_ENDPOINT: string;
}

// Define our MCP agent with tools
export class MyMCP extends McpAgent {
  server = new McpServer({
    name: "Smartsheet MCP Server", // Updated name
    version: "1.0.0",
  });
  ...
  constructor(ctx: DurableObjectState, env: Env) {
    super(ctx, env);
    this.api = createSmartsheetDirectAPI(
        env.SMARTSHEET_API_KEY,
        env.SMARTSHEET_ENDPOINT
    );
  }
    ...
    this.server.tool(
      ...
      async ({ sheetId, include }) => {
        try {
          ...
          const sheet = await this.api.getSheet(sheetId, include);
    ...
    this.server.tool(
      ...
      async ({ sheetId }) => {
        try {
          ...
          const version = await this.api.getSheetVersion(sheetId);
    ...
    this.server.tool(
      ...
      async ({ sheetId, rowId, columnId, include, pageSize, page }) => {
        try {
          ...
          const history = await this.api.getCellHistory(sheetId, rowId, columnId, include, pageSize, page);
    ...
    this.server.tool(
      ...
      async ({ sheetId, rows }) => {
        try {
          ...
          const result = await this.api.updateRows(sheetId, rows);
    ...
    this.server.tool(
      ...
      async ({ sheetId, rows }) => {
        try {
          ...
          const result = await this.api.addRows(sheetId, rows);
      ...
      this.server.tool(
        ...
        async ({ sheetId, rowIds, ignoreRowsNotFound }) => {
          try {
            ...
            const result = await this.api.deleteRows(sheetId, rowIds, ignoreRowsNotFound);
    ...
    this.server.tool(
      ...
      async ({ sheetId }) => {
        try {
          ...
          const location = await this.api.getSheetLocation(sheetId);
    ...
    this.server.tool(
      ...
      async ({ sheetId, destinationName, destinationFolderId }) => {
        try {
          ...
          const result = await this.api.copySheet(sheetId, destinationName, destinationFolderId);
    ...
    this.server.tool(
      ...
      async ({ name, columns, folderId }) => {
        try {
          ...
          const result = await this.api.createSheet(name, columns, folderId);
    ...
    this.server.tool(
      ...
      async (options) => {
        try {
          ...
          const result = await createVersionBackup(this.api, options);
    ...
    this.server.tool(
      ...
      async ({ sheetId, include, pageSize, page, includeAll }) => {
        try {
          ...
          const discussions = await this.api.getSheetDiscussions(sheetId, include, pageSize, page, includeAll);
    ...
    this.server.tool(
      ...
      async ({ sheetId, rowId, commentText }) => {
        try {
          ...
          const result = await this.api.createRowDiscussion(sheetId, rowId, commentText);
    ...
    this.server.tool(
      ...
      async ({ sheetId, rowIds, columnIds, includeAttachments, includeDiscussions, message, subject, ccMe, sendTo }) => {
        try {
          ...
          const result = await this.api.createUpdateRequest(sheetId, {
            rowIds,
            columnIds,
            includeAttachments,
            includeDiscussions,
    ...
    this.server.tool(
        ...
        async ({ }) => {
          try {
            ...
            const workspace = await this.api.getWorkspaces();
    ...
    this.server.tool(
        ...
        async ({ workspaceName }) => {
          try {
            ...
            const workspace = await this.api.createWorkspace(workspaceName);
    ...
    this.server.tool(
        ...
        async ({ folderId}) => {
          try {
            ...
            const folder = await this.api.getFolder(folderId);
    ...
    this.server.tool(
        ...
        async ({ folderId, folderName }) => {
          try {
            ...
            const folder = await this.api.createFolder(folderId, folderName);
    ...
    this.server.tool(
        ...
        async ({ workspaceId, folderName }) => {
          try {
            ...
            const folder = await this.api.createWorkspaceFolder(workspaceId, folderName);
...
export default {
  fetch(request: Request, env: Env, ctx: ExecutionContext) {
    ...
    process.env.SMARTSHEET_API_KEY = request.headers.get("SMARTSHEET_API_KEY") || process.env.SMARTSHEET_API_KEY;
    process.env.SMARTSHEET_ENDPOINT = request.headers.get("SMARTSHEET_ENDPOINT") || process.env.SMARTSHEET_ENDPOINT;

    console.log(`SMARTSHEET_API_KEY`)
