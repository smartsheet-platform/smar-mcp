 ...
 * 
 * @export
 * @interface ProofsGetAllProofs200Response
 */
export interface ProofsGetAllProofs200Response {
    /**
     ...
     * @type {number}
     * @memberof ProofsGetAllProofs200Response
     */
...
/**
 * Check if a given object implements the ProofsGetAllProofs200Response interface.
 */
export function instanceOfProofsGetAllProofs200Response(value: object): value is ProofsGetAllProofs200Response {
    return true;
}

export function ProofsGetAllProofs200ResponseFromJSON(json: any): ProofsGetAllProofs200Response {
    return ProofsGetAllProofs200ResponseFromJSONTyped(json, false);
}

export function ProofsGetAllProofs200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProofsGetAllProofs200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ProofsGetAllProofs200ResponseToJSON(json: any): ProofsGetAllProofs200Response {
    return ProofsGetAllProofs200ResponseToJSONTyped(json, false);
}

export function ProofsGetAllProofs200ResponseToJSONTyped(value?: Omit<ProofsGetAllProofs200Response, 'pageNumber'|'pageSize'|'totalPages'|'totalCount'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
