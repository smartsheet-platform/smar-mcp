        ...
        if (error.response) {
            ...
            if (data && data.errorCode) {
                switch (data.errorCode) {
                    case 1002: return `Access Denied: Your API Token is invalid or expired. Check SMARTSHEET_API_KEY.`;
                    case 1003: return `Permission Denied: You do not have access to this resource.`;
                    case 1004: return `Resource Not Found: The requested Sheet, Row, or Column does not exist.`;
                    case 4004: return `Row Not Found: The specified row ID could not be located.`;
                    default:
