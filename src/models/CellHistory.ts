...
/**
 * Check if a given object implements the CellHistory interface.
 */
export function instanceOfCellHistory(value: object): value is CellHistory {
    return true;
}

export function CellHistoryFromJSON(json: any): CellHistory {
    return CellHistoryFromJSONTyped(json, false);
}

export function CellHistoryFromJSONTyped(json: any, ignoreDiscriminator: boolean): CellHistory {
    if (json == null) {
        return json;
    }
    return {
...
export function CellHistoryToJSON(json: any): CellHistory {
    return CellHistoryToJSONTyped(json, false);
}

export function CellHistoryToJSONTyped(value?: CellHistory | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
