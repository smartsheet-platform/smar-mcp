 ...
 * 
 * @export
 * @interface AutomationrulesList200Response
 */
export interface AutomationrulesList200Response {
    /**
     ...
     * @type {number}
     * @memberof AutomationrulesList200Response
     */
...
/**
 * Check if a given object implements the AutomationrulesList200Response interface.
 */
export function instanceOfAutomationrulesList200Response(value: object): value is AutomationrulesList200Response {
    return true;
}

export function AutomationrulesList200ResponseFromJSON(json: any): AutomationrulesList200Response {
    return AutomationrulesList200ResponseFromJSONTyped(json, false);
}

export function AutomationrulesList200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AutomationrulesList200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(AutomationRuleFromJSON)),
    };
}

export function AutomationrulesList200ResponseToJSON(json: any): AutomationrulesList200Response {
    return AutomationrulesList200ResponseToJSONTyped(json, false);
}

export function AutomationrulesList200ResponseToJSONTyped(value?: Omit<AutomationrulesList200Response, 'pageNumber'|'pageSize'|'totalPages'|'totalCount'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(AutomationRuleToJSON)),
    };
}
