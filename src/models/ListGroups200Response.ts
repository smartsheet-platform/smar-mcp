...
export function ListGroups200ResponseToJSONTyped(value?: Omit<ListGroups200Response, 'pageNumber'|'pageSize'|'totalPages'|'totalCount'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
