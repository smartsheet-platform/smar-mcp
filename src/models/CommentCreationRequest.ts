...
export interface CommentCreationRequest {
     ...
     * Comment body.
     * @type {string}
     * @memberof CommentCreationRequest
     */
    text?: string;
}

/**
 * Check if a given object implements the CommentCreationRequest interface.
 */
export function instanceOfCommentCreationRequest(value: object): value is CommentCreationRequest {
    return true;
}

export function CommentCreationRequestFromJSON(json: any): CommentCreationRequest {
    return CommentCreationRequestFromJSONTyped(json, false);
}

export function CommentCreationRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CommentCreationRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function CommentCreationRequestToJSON(json: any): CommentCreationRequest {
    return CommentCreationRequestToJSONTyped(json, false);
}

export function CommentCreationRequestToJSONTyped(value?: CommentCreationRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
