 ...
 * @export
 * @interface FolderSimpleResponse
 */
export interface FolderSimpleResponse {
    /**
     * Folder name.
     * @type {string}
     * @memberof FolderSimpleResponse
     */
    name?: string;
}

/**
 * Check if a given object implements the FolderSimpleResponse interface.
 */
export function instanceOfFolderSimpleResponse(value: object): value is FolderSimpleResponse {
    return true;
}

export function FolderSimpleResponseFromJSON(json: any): FolderSimpleResponse {
    return FolderSimpleResponseFromJSONTyped(json, false);
}

export function FolderSimpleResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): FolderSimpleResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function FolderSimpleResponseToJSON(json: any): FolderSimpleResponse {
    return FolderSimpleResponseToJSONTyped(json, false);
}

export function FolderSimpleResponseToJSONTyped(value?: FolderSimpleResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
