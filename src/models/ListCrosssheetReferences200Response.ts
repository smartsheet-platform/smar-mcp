 ...
 * 
 * @export
 * @interface ListCrosssheetReferences200Response
 */
export interface ListCrosssheetReferences200Response {
    /**
     ...
     * @type {number}
     * @memberof ListCrosssheetReferences200Response
     */
     ...
     * @memberof ListCrosssheetReferences200Response
     */
    data?: Array<CrossSheetReference>;
}

/**
 * Check if a given object implements the ListCrosssheetReferences200Response interface.
 */
export function instanceOfListCrosssheetReferences200Response(value: object): value is ListCrosssheetReferences200Response {
    return true;
}

export function ListCrosssheetReferences200ResponseFromJSON(json: any): ListCrosssheetReferences200Response {
    return ListCrosssheetReferences200ResponseFromJSONTyped(json, false);
}

export function ListCrosssheetReferences200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListCrosssheetReferences200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(CrossSheetReferenceFromJSON)),
    };
}

export function ListCrosssheetReferences200ResponseToJSON(json: any): ListCrosssheetReferences200Response {
    return ListCrosssheetReferences200ResponseToJSONTyped(json, false);
}

export function ListCrosssheetReferences200ResponseToJSONTyped(value?: Omit<ListCrosssheetReferences200Response, 'pageNumber'|'pageSize'|'totalPages'|'totalCount'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(CrossSheetReferenceToJSON)),
    };
}
