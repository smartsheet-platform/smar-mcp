 ...
 * @export
 * @interface FolderNameOnly
 */
export interface FolderNameOnly {
    /**
     * Folder name.
     * @type {string}
     * @memberof FolderNameOnly
     */
    name?: string;
}

/**
 * Check if a given object implements the FolderNameOnly interface.
 */
export function instanceOfFolderNameOnly(value: object): value is FolderNameOnly {
    return true;
}

export function FolderNameOnlyFromJSON(json: any): FolderNameOnly {
    return FolderNameOnlyFromJSONTyped(json, false);
}

export function FolderNameOnlyFromJSONTyped(json: any, ignoreDiscriminator: boolean): FolderNameOnly {
    if (json == null) {
        return json;
    }
    return {
...
export function FolderNameOnlyToJSON(json: any): FolderNameOnly {
    return FolderNameOnlyToJSONTyped(json, false);
}

export function FolderNameOnlyToJSONTyped(value?: FolderNameOnly | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
