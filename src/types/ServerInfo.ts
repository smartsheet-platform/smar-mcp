...
import type { FormatTables } from './FormatTables';
import {
    FormatTablesFromJSON,
    FormatTablesFromJSONTyped,
    FormatTablesToJSON,
    FormatTablesToJSONTyped,
} from './FormatTables';
...
export function ServerInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServerInfo {
    ...
    return {
        ...
        'formats': json['formats'] == null ? undefined : FormatTablesFromJSON(json['formats']),
...
export function ServerInfoToJSONTyped(value?: ServerInfo | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'formats': FormatTablesToJSON(value['formats']),
