 ...
 * 
 * @export
 * @interface UpdateProofStatusRequest
 */
export interface UpdateProofStatusRequest {
    /**
     * 
     * @type {boolean}
     * @memberof UpdateProofStatusRequest
     */
    isCompleted?: boolean;
}

/**
 * Check if a given object implements the UpdateProofStatusRequest interface.
 */
export function instanceOfUpdateProofStatusRequest(value: object): value is UpdateProofStatusRequest {
    return true;
}

export function UpdateProofStatusRequestFromJSON(json: any): UpdateProofStatusRequest {
    return UpdateProofStatusRequestFromJSONTyped(json, false);
}

export function UpdateProofStatusRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateProofStatusRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateProofStatusRequestToJSON(json: any): UpdateProofStatusRequest {
    return UpdateProofStatusRequestToJSONTyped(json, false);
}

export function UpdateProofStatusRequestToJSONTyped(value?: UpdateProofStatusRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
