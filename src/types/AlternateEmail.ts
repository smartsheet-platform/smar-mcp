 ...
 * 
 * @export
 * @interface AlternateEmail
 */
export interface AlternateEmail {
    /**
     * AlternateEmail Id.
     * @type {number}
     * @memberof AlternateEmail
     */
    id?: number;
    /**
...
/**
 * Check if a given object implements the AlternateEmail interface.
 */
export function instanceOfAlternateEmail(value: object): value is AlternateEmail {
    return true;
}

export function AlternateEmailFromJSON(json: any): AlternateEmail {
    return AlternateEmailFromJSONTyped(json, false);
}

export function AlternateEmailFromJSONTyped(json: any, ignoreDiscriminator: boolean): AlternateEmail {
    if (json == null) {
        return json;
    }
    return {
...
export function AlternateEmailToJSON(json: any): AlternateEmail {
    return AlternateEmailToJSONTyped(json, false);
}

export function AlternateEmailToJSONTyped(value?: AlternateEmail | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
