...
export function ListUsers200ResponseToJSONTyped(value?: Omit<ListUsers200Response, 'pageNumber'|'pageSize'|'totalPages'|'totalCount'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
