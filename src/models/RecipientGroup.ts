...
export interface RecipientGroup {
     ...
     * @type {number}
     * @memberof RecipientGroup
     */
    groupId?: number;
}

/**
 * Check if a given object implements the RecipientGroup interface.
 */
export function instanceOfRecipientGroup(value: object): value is RecipientGroup {
    return true;
}

export function RecipientGroupFromJSON(json: any): RecipientGroup {
    return RecipientGroupFromJSONTyped(json, false);
}

export function RecipientGroupFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecipientGroup {
    if (json == null) {
        return json;
    }
    return {
...
export function RecipientGroupToJSON(json: any): RecipientGroup {
    return RecipientGroupToJSONTyped(json, false);
}

export function RecipientGroupToJSONTyped(value?: RecipientGroup | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
