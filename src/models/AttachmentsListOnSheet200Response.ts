 ...
 * 
 * @export
 * @interface AttachmentsListOnSheet200Response
 */
export interface AttachmentsListOnSheet200Response {
    /**
     ...
     * @type {number}
     * @memberof AttachmentsListOnSheet200Response
     */
...
/**
 * Check if a given object implements the AttachmentsListOnSheet200Response interface.
 */
export function instanceOfAttachmentsListOnSheet200Response(value: object): value is AttachmentsListOnSheet200Response {
    return true;
}

export function AttachmentsListOnSheet200ResponseFromJSON(json: any): AttachmentsListOnSheet200Response {
    return AttachmentsListOnSheet200ResponseFromJSONTyped(json, false);
}

export function AttachmentsListOnSheet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttachmentsListOnSheet200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(AttachmentFromJSON)),
    };
}

export function AttachmentsListOnSheet200ResponseToJSON(json: any): AttachmentsListOnSheet200Response {
    return AttachmentsListOnSheet200ResponseToJSONTyped(json, false);
}

export function AttachmentsListOnSheet200ResponseToJSONTyped(value?: Omit<AttachmentsListOnSheet200Response, 'pageNumber'|'pageSize'|'totalPages'|'totalCount'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(AttachmentToJSON)),
    };
}
