...
/**
 * Check if a given object implements the SightName interface.
 */
export function instanceOfSightName(value: object): value is SightName {
    return true;
}

export function SightNameFromJSON(json: any): SightName {
    return SightNameFromJSONTyped(json, false);
}

export function SightNameFromJSONTyped(json: any, ignoreDiscriminator: boolean): SightName {
    if (json == null) {
        return json;
    }
    return {
...
export function SightNameToJSON(json: any): SightName {
    return SightNameToJSONTyped(json, false);
}

export function SightNameToJSONTyped(value?: SightName | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
