 ...
 * @export
 * @interface DatetimeObjectValue
 */
export interface DatetimeObjectValue {
    /**
     * 
     * @type {string}
     * @memberof DatetimeObjectValue
     */
    objectType?: DatetimeObjectValueObjectTypeEnum;
    /**
 ...
 * @export
 */
export const DatetimeObjectValueObjectTypeEnum = {
    Datetime: 'DATETIME'
} as const;
export type DatetimeObjectValueObjectTypeEnum = typeof DatetimeObjectValueObjectTypeEnum[keyof typeof DatetimeObjectValueObjectTypeEnum];


/**
 * Check if a given object implements the DatetimeObjectValue interface.
 */
export function instanceOfDatetimeObjectValue(value: object): value is DatetimeObjectValue {
    return true;
}

export function DatetimeObjectValueFromJSON(json: any): DatetimeObjectValue {
    return DatetimeObjectValueFromJSONTyped(json, false);
}

export function DatetimeObjectValueFromJSONTyped(json: any, ignoreDiscriminator: boolean): DatetimeObjectValue {
    if (json == null) {
        return json;
    }
    return {
...
export function DatetimeObjectValueToJSON(json: any): DatetimeObjectValue {
    return DatetimeObjectValueToJSONTyped(json, false);
}

export function DatetimeObjectValueToJSONTyped(value?: DatetimeObjectValue | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
