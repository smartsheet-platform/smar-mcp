...
/**
 * Check if a given object implements the MiniUser interface.
 */
export function instanceOfMiniUser(value: object): value is MiniUser {
    return true;
}

export function MiniUserFromJSON(json: any): MiniUser {
    return MiniUserFromJSONTyped(json, false);
}

export function MiniUserFromJSONTyped(json: any, ignoreDiscriminator: boolean): MiniUser {
    if (json == null) {
        return json;
    }
    return {
...
export function MiniUserToJSON(json: any): MiniUser {
    return MiniUserToJSONTyped(json, false);
}

export function MiniUserToJSONTyped(value?: Omit<MiniUser, 'name'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
