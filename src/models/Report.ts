...
export interface Report {
     ...
     * @memberof Report
     */
    resourceManagementType?: ReportResourceManagementTypeEnum;
    /**
     * 
     * @type {Array<Row>}
     * @memberof Report
 ...
 * @export
 */
export const ReportResourceManagementTypeEnum = {
    None: 'NONE',
    LegacyResourceManagement: 'LEGACY_RESOURCE_MANAGEMENT',
    ResourceManagementBySmartsheet: 'RESOURCE_MANAGEMENT_BY_SMARTSHEET'
} as const;
export type ReportResourceManagementTypeEnum = typeof ReportResourceManagementTypeEnum[keyof typeof ReportResourceManagementTypeEnum];
...
export function ReportFromJSONTyped(json: any, ignoreDiscriminator: boolean): Report {
    ...
    return {
        ...
        'sourceSheets': json['sourceSheets'] == null ? undefined : ((json['sourceSheets'] as Array<any>).map(SheetFromJSON)),
...
export function ReportToJSONTyped(value?: Report | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'sourceSheets': value['sourceSheets'] == null ? undefined : ((value['sourceSheets'] as Array<any>).map(SheetToJSON)),
