...
export function ListWorkspaces200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListWorkspaces200Response {
    ...
    return {
        ...
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(WorkspaceListingFromJSON)),
    };
}
...
export function ListWorkspaces200ResponseToJSONTyped(value?: Omit<ListWorkspaces200Response, 'pageNumber'|'pageSize'|'totalPages'|'totalCount'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(WorkspaceListingToJSON)),
    };
}
