 ...
 * 
 * @export
 * @interface DiscussionsList200Response
 */
export interface DiscussionsList200Response {
    /**
     ...
     * @type {number}
     * @memberof DiscussionsList200Response
     */
...
/**
 * Check if a given object implements the DiscussionsList200Response interface.
 */
export function instanceOfDiscussionsList200Response(value: object): value is DiscussionsList200Response {
    return true;
}

export function DiscussionsList200ResponseFromJSON(json: any): DiscussionsList200Response {
    return DiscussionsList200ResponseFromJSONTyped(json, false);
}

export function DiscussionsList200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DiscussionsList200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function DiscussionsList200ResponseToJSON(json: any): DiscussionsList200Response {
    return DiscussionsList200ResponseToJSONTyped(json, false);
}

export function DiscussionsList200ResponseToJSONTyped(value?: Omit<DiscussionsList200Response, 'pageNumber'|'pageSize'|'totalPages'|'totalCount'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
