 ...
 * @export
 * @interface CrossSheetReferenceRequestWithRowIds
 */
export interface CrossSheetReferenceRequestWithRowIds {
    /**
     * Sheet Id of source sheet.
     * @type {number}
     * @memberof CrossSheetReferenceRequestWithRowIds
     */
...
/**
 * Check if a given object implements the CrossSheetReferenceRequestWithRowIds interface.
 */
export function instanceOfCrossSheetReferenceRequestWithRowIds(value: object): value is CrossSheetReferenceRequestWithRowIds {
    return true;
}

export function CrossSheetReferenceRequestWithRowIdsFromJSON(json: any): CrossSheetReferenceRequestWithRowIds {
    return CrossSheetReferenceRequestWithRowIdsFromJSONTyped(json, false);
}

export function CrossSheetReferenceRequestWithRowIdsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CrossSheetReferenceRequestWithRowIds {
    if (json == null) {
        return json;
    }
    return {
...
export function CrossSheetReferenceRequestWithRowIdsToJSON(json: any): CrossSheetReferenceRequestWithRowIds {
    return CrossSheetReferenceRequestWithRowIdsToJSONTyped(json, false);
}

export function CrossSheetReferenceRequestWithRowIdsToJSONTyped(value?: CrossSheetReferenceRequestWithRowIds | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
