...
export interface ReportColumn {
    ...
    virtualId?: number;
    /**
     * Returns true only for the special "Sheet Name" report column.
     * @type {boolean}
     * @memberof ReportColumn
     */
     ...
     * @memberof ReportColumn
     */
    version?: ReportColumnVersionEnum;
    /**
 ...
 * @export
 */
export const ReportColumnSystemColumnTypeEnum = {
...
export type ReportColumnSystemColumnTypeEnum = typeof ReportColumnSystemColumnTypeEnum[keyof typeof ReportColumnSystemColumnTypeEnum];

/**
 * @export
 */
export const ReportColumnTagsEnum = {
...
export type ReportColumnTagsEnum = typeof ReportColumnTagsEnum[keyof typeof ReportColumnTagsEnum];

/**
 * @export
 */
export const ReportColumnTypeEnum = {
...
export type ReportColumnTypeEnum = typeof ReportColumnTypeEnum[keyof typeof ReportColumnTypeEnum];

/**
 * @export
 */
export const ReportColumnVersionEnum = {
    NUMBER_0: 0,
    NUMBER_1: 1,
    NUMBER_2: 2
} as const;
export type ReportColumnVersionEnum = typeof ReportColumnVersionEnum[keyof typeof ReportColumnVersionEnum];


/**
 * Check if a given object implements the ReportColumn interface.
 */
export function instanceOfReportColumn(value: object): value is ReportColumn {
    return true;
}
...
export function ReportColumnFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReportColumn {
    ...
    return {
        ...
        'virtualId': json['virtualId'] == null ? undefined : json['virtualId'],
        'sheetNameColumn': json['sheetNameColumn'] == null ? undefined : json['sheetNameColumn'],
...
export function ReportColumnToJSON(json: any): ReportColumn {
    return ReportColumnToJSONTyped(json, false);
}

export function ReportColumnToJSONTyped(value?: ReportColumn | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'sheetNameColumn': value['sheetNameColumn'],
