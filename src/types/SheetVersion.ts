...
export interface SheetVersion {
     ...
     * @type {number}
     * @memberof SheetVersion
     */
    version?: number;
}

/**
 * Check if a given object implements the SheetVersion interface.
 */
export function instanceOfSheetVersion(value: object): value is SheetVersion {
    return true;
}

export function SheetVersionFromJSON(json: any): SheetVersion {
    return SheetVersionFromJSONTyped(json, false);
}

export function SheetVersionFromJSONTyped(json: any, ignoreDiscriminator: boolean): SheetVersion {
    if (json == null) {
        return json;
    }
    return {
...
export function SheetVersionToJSON(json: any): SheetVersion {
    return SheetVersionToJSONTyped(json, false);
}

export function SheetVersionToJSONTyped(value?: SheetVersion | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
