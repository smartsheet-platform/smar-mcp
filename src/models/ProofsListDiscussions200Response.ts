 ...
 * 
 * @export
 * @interface ProofsListDiscussions200Response
 */
export interface ProofsListDiscussions200Response {
    /**
     ...
     * @type {number}
     * @memberof ProofsListDiscussions200Response
     */
...
/**
 * Check if a given object implements the ProofsListDiscussions200Response interface.
 */
export function instanceOfProofsListDiscussions200Response(value: object): value is ProofsListDiscussions200Response {
    return true;
}

export function ProofsListDiscussions200ResponseFromJSON(json: any): ProofsListDiscussions200Response {
    return ProofsListDiscussions200ResponseFromJSONTyped(json, false);
}

export function ProofsListDiscussions200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProofsListDiscussions200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(DiscussionFromJSON)),
    };
}

export function ProofsListDiscussions200ResponseToJSON(json: any): ProofsListDiscussions200Response {
    return ProofsListDiscussions200ResponseToJSONTyped(json, false);
}

export function ProofsListDiscussions200ResponseToJSONTyped(value?: Omit<ProofsListDiscussions200Response, 'pageNumber'|'pageSize'|'totalPages'|'totalCount'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(DiscussionToJSON)),
    };
}
