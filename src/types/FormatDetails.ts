...
export interface FormatDetails {
     ...
     * @type {string}
     * @memberof FormatDetails
     */
    paperSize?: FormatDetailsPaperSizeEnum;
}
 ...
 * @export
 */
export const FormatDetailsPaperSizeEnum = {
    A0: 'A0',
    A1: 'A1',
    A2: 'A2',
    A3: 'A3',
...
export type FormatDetailsPaperSizeEnum = typeof FormatDetailsPaperSizeEnum[keyof typeof FormatDetailsPaperSizeEnum];


/**
 * Check if a given object implements the FormatDetails interface.
 */
export function instanceOfFormatDetails(value: object): value is FormatDetails {
    return true;
}

export function FormatDetailsFromJSON(json: any): FormatDetails {
    return FormatDetailsFromJSONTyped(json, false);
}

export function FormatDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): FormatDetails {
    if (json == null) {
        return json;
    }
    return {
        
        'paperSize': json['paperSize'] == null ? undefined : json['paperSize'],
    };
}

export function FormatDetailsToJSON(json: any): FormatDetails {
    return FormatDetailsToJSONTyped(json, false);
}

export function FormatDetailsToJSONTyped(value?: FormatDetails | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
