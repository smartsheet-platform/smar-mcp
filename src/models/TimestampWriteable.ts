 ...
 * @export
 */
export type TimestampWriteable = Date | number;

export function TimestampWriteableFromJSON(json: any): TimestampWriteable {
    return TimestampWriteableFromJSONTyped(json, false);
}

export function TimestampWriteableFromJSONTyped(json: any, ignoreDiscriminator: boolean): TimestampWriteable {
    if (json == null) {
        return json;
    }
...
export function TimestampWriteableToJSON(json: any): any {
    return TimestampWriteableToJSONTyped(json, false);
}

export function TimestampWriteableToJSONTyped(value?: TimestampWriteable | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
