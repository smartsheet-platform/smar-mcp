 ...
 */
export function instanceOfGetFavorites200Response(value: object): value is GetFavorites200Response {
    return true;
}
...
export function GetFavorites200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetFavorites200Response {
    ...
    return {
        ...
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(FavoriteFromJSON)),
    };
}

export function GetFavorites200ResponseToJSON(json: any): GetFavorites200Response {
    return GetFavorites200ResponseToJSONTyped(json, false);
}

export function GetFavorites200ResponseToJSONTyped(value?: Omit<GetFavorites200Response, 'pageNumber'|'pageSize'|'totalPages'|'totalCount'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(FavoriteToJSON)),
    };
}
