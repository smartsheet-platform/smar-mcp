 ...
 * 
 * @export
 * @interface ProofsListAttachments200Response
 */
export interface ProofsListAttachments200Response {
    /**
     ...
     * @type {number}
     * @memberof ProofsListAttachments200Response
     */
...
/**
 * Check if a given object implements the ProofsListAttachments200Response interface.
 */
export function instanceOfProofsListAttachments200Response(value: object): value is ProofsListAttachments200Response {
    return true;
}

export function ProofsListAttachments200ResponseFromJSON(json: any): ProofsListAttachments200Response {
    return ProofsListAttachments200ResponseFromJSONTyped(json, false);
}

export function ProofsListAttachments200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProofsListAttachments200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ProofsListAttachments200ResponseToJSON(json: any): ProofsListAttachments200Response {
    return ProofsListAttachments200ResponseToJSONTyped(json, false);
}

export function ProofsListAttachments200ResponseToJSONTyped(value?: Omit<ProofsListAttachments200Response, 'pageNumber'|'pageSize'|'totalPages'|'totalCount'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
