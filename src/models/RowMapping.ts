...
/**
 * Check if a given object implements the RowMapping interface.
 */
export function instanceOfRowMapping(value: object): value is RowMapping {
    return true;
}

export function RowMappingFromJSON(json: any): RowMapping {
    return RowMappingFromJSONTyped(json, false);
}

export function RowMappingFromJSONTyped(json: any, ignoreDiscriminator: boolean): RowMapping {
    if (json == null) {
        return json;
    }
    return {
...
export function RowMappingToJSON(json: any): RowMapping {
    return RowMappingToJSONTyped(json, false);
}

export function RowMappingToJSONTyped(value?: RowMapping | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
