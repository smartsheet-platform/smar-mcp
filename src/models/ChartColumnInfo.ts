 ...
 * 
 * @export
 * @interface ChartColumnInfo
 */
export interface ChartColumnInfo {
    /**
     * 
     * @type {string}
     * @memberof ChartColumnInfo
     */
    type?: ChartColumnInfoTypeEnum;
}
 ...
 * @export
 */
export const ChartColumnInfoTypeEnum = {
    AbstractDateTime: 'ABSTRACT_DATE_TIME',
    Checkbox: 'CHECKBOX',
...
export type ChartColumnInfoTypeEnum = typeof ChartColumnInfoTypeEnum[keyof typeof ChartColumnInfoTypeEnum];


/**
 * Check if a given object implements the ChartColumnInfo interface.
 */
export function instanceOfChartColumnInfo(value: object): value is ChartColumnInfo {
    return true;
}

export function ChartColumnInfoFromJSON(json: any): ChartColumnInfo {
    return ChartColumnInfoFromJSONTyped(json, false);
}

export function ChartColumnInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChartColumnInfo {
    if (json == null) {
        return json;
    }
    return {
...
export function ChartColumnInfoToJSON(json: any): ChartColumnInfo {
    return ChartColumnInfoToJSONTyped(json, false);
}

export function ChartColumnInfoToJSONTyped(value?: ChartColumnInfo | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
